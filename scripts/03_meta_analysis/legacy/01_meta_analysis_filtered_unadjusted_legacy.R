...
output_dir <- file.path(project_root, "results", "meta_analysis", "filtered_unadjusted")
...
files <- tibble::tribble(
  ...
  "GSE278723_CA1",   "hippocampus_CA1",       file.path(deg_root, "GSE278723", "CA1", "significant_DEGs_unadjusted.csv"),
  "GSE278723_CA2",   "hippocampus_CA2",       file.path(deg_root, "GSE278723", "CA2", "significant_DEGs_unadjusted.csv"),
  "GSE278723_CA3",   "hippocampus_CA3",       file.path(deg_root, "GSE278723", "CA3", "significant_DEGs_unadjusted.csv"),
  "GSE278723_CA4",   "hippocampus_CA4",       file.path(deg_root, "GSE278723", "CA4", "significant_DEGs_unadjusted.csv"),
  "GSE278723_NX",    "entorhinal_cortex",     file.path(deg_root, "GSE278723", "NX", "significant_DEGs_unadjusted.csv"),
  
  # Other GEOs
  "GSE67333",        "hippocampus",           file.path(deg_root, "GSE67333", "significant_DEGs_unadjusted.csv"),
  "GSE95587",        "fusiform_gyrus",        file.path(deg_root, "GSE95587", "significant_DEGs_unadjusted.csv"),
  "GSE159699",       "lateral_temporal_lobe", file.path(deg_root, "GSE159699", "significant_DEGs_unadjusted.csv"),
  "GSE203206",       "occipital_lobe",        file.path(deg_root, "GSE203206", "significant_DEGs_unadjusted.csv")
)
